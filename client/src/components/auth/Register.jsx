...
function Register() {
  ...
  return (
    <div className="p-6 min-h-[400px] grid place-items-center bg-yellow-400">
      <form
        method="post"
        className="w-[300px] h-[300px] bg-white rounded-xl shadow-lg"
      >
        <div className="p-8">
          ...
          <input
            ...
            className="cursor-pointer bg-slate-800 font-bold text-white p-2 center w-full rounded-md mt-4 hover:opacity-95 "
          />
        </div>
      </form>
    </div>
